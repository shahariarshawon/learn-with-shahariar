    ...
    <footer className="">
      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li className="hover:text-[#49bbbd] cursor-pointer">
              Success Stories
            </li>
        ...
        {/* NEWSLETTER */}
        <div>
          <h3 className=" font-semibold mb-4">Get Course Updates</h3>
          ...
          <div>
            <div className="pt-5 flex gap-10 max-sm:justify-center">
      ...
      <div className="border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm">
            © {new Date().getFullYear()} Learn With Shahariar. All rights
            reserved.
          </p>
        </div>
      </div>
